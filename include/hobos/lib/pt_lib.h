...
#define PT_AF_ACCESSED	BITP(PT_AF_POS)

//UXN
#define PT_UXN_NX	BITP(PT_UXN_POS)

//PXN
#define PT_PXN_NX	BITP(PT_PXN_POS)
...
#define PT_INDEX_MEM	BITP(PT_INDEX_POS)     // normal memory
...
#define PTE_FLAGS_KERNEL_GENERIC   \
		(PT_KERNEL | PT_PAGE | PT_AP_RW | PT_AF_ACCESSED \
		 | PT_UXN_NX | PT_SH_I | PT_INDEX_MEM)

#define PTE_FLAGS_USER_GENERIC   \
		(PT_USER | PT_PAGE | PT_AP_RW | PT_AF_ACCESSED \
